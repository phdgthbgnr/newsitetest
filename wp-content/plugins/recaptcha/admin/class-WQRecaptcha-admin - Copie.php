...
class WQRecaptcha_Admin
{
    ...
    /**
     * pre update option sitekey
     *
     * @since    1.0.0
     */
    public function update_field_sitekey($old_value, $new_value)
    {
        die($old_value . ' / ' . $new_value);
    }
    ...
    public function register_plugin_settings()
    {
        ...
        add_settings_field(
            ...
            $this->plugin_name,
            $this->section,
            array('sitekey', __('Explanation for secret key', 'ani_plugin'))
        );
    ...
    {
        printf('<input name="secretkey" id="secretkey" placeholder="secret key" class="form_input_key" value="%s"); ?>"', esc_attr(get_option('secretkey')));
    }

    private function field_callback_sitekey()
    {
        printf('<input name="sitekey" id="sitekey" placeholder="site key" class="form_input_key" value="%s"); ?>"', esc_attr(get_option('sitekey')));
    }
